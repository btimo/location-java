...
public class GenerationFacture {
    ...
    private static void addTitlePage(Document document)
        ...
        preface.add(new Paragraph("Document généré par : " + System.getProperty("user.name") + ", " + new Date(), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                smallBold));
        addEmptyLine(preface, 3);
        preface.add(new Paragraph("Facture pour l'emprunteur X ",
                smallBold));
        ...
        preface.add(new Paragraph("Montant total : ",
                redFont));
